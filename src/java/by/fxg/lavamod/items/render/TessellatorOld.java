...
public class TessellatorOld {
	...
	/**
	 * Boolean used to check if we should use vertex buffers. Initialized to false
	 * and never changed.
	 */
	...
	public static TessellatorOld instance = new TessellatorOld(2097152);
	...
	private TessellatorOld(int par1) {
	}

	public TessellatorOld() {
	}
		...
		if (!this.isDrawing) {
			...
			while (offs < vertexCount) {
				...
				if (this.useVBO) {
					...
					ARBVertexBufferObject.glBufferDataARB(ARBVertexBufferObject.GL_ARRAY_BUFFER_ARB, this.byteBuffer,
